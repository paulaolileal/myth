...
/// <summary>
/// Validation rule that checks if a nullable DateTime value represents a future date/time
/// If the value is null, the validation passes
/// </summary>
internal sealed class NullableFutureRule : ValidationRuleBase<DateTime?> {

	/// <summary>
	/// Evaluates whether the nullable DateTime value represents a future date/time
	/// </summary>
	...
	protected override string GetDefaultMessage( DateTime? value ) {
		return value.HasValue
			? $"The value '{value.Value:yyyy-MM-dd HH:mm:ss}' must be a future date/time."
			: "The value must be a future date/time.";
	}
}