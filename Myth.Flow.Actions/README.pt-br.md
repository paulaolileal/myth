...
**✅ Compatível com todas as versões do Swashbuckle (6.x, 7.x, 8.x+)** - Tratamento de fallback seguro garante que sua aplicação não irá quebrar devido a incompatibilidades de versão.
