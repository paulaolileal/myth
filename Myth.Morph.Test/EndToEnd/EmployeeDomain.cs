...
internal sealed class FakeEmployeePhotoService : IEmployeePhotoService {
    private readonly Dictionary<int, string> _photos;

    public FakeEmployeePhotoService( Dictionary<int, string>? photos = null ) {
        _photos = photos ?? [];
    }
