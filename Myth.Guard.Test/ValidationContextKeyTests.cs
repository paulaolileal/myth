...
public class ValidationContextKeyTests
{
    ...
    [Fact]
    public void Custom_WithNullKey_ShouldCreateContextWithNullKey()
    {
        // Act
        var customContext = ValidationContextKey.Custom(null);

        // Assert
        customContext.Key.Should().BeNull();
    }
    ...
    {
        // Arrange
        var context = ValidationContextKey.Custom(null);
