namespace Myth.Exceptions {
    ...
    public class MapContentException : Exception {
        ...
        public MapContentException( Type typeInformed, string contentExpected, Exception innerException ) : base( $"The type informed is different from the type expected by the request!", innerException ) {
