...
namespace Myth.Documentations.Settings {
	...
	public partial class SwaggerSettings( ) {
		...
		/// </remarks>
		public SwaggerSettings RequireAuthenticationIf( Func<IHostEnvironment, bool> environmentCondition, bool validateTokens = true, params AuthorizationType[ ] allowedSchemes ) {
